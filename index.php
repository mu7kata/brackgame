        ...
        if($attackFlg){
            ...
            $_SESSION['tess']=2;
                ...
                if($_SESSION['human']-> getHp() <= 0){
                    $_SESSION['test']=7;
                    debug('$_test2：'.print_r($_SESSION['test'],true));
                }
                ...
                if(!empty($_SESSION['game'])){
                    ...
                    } else if($_SESSION['test']==7){
                    Condition::set('もう、、無理。。');
                    $_SESSION['tess']=2;
                    $_SESSION['game'] = 8;
                    $_SESSION['test'] = 8;
                }}}}
debug('$_game：'.print_r($_SESSION,true));
$_POST = array();
